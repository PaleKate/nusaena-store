        ...
        <div id="content-wrapper" class="d-flex flex-column ml-auto">
            ...
            <div id="content" class="mt-4">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Paket Ongkir</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								...
								<a href="paket-tambah.php" class="btn btn-sm btn-primary btn-icon-split">
									<span class="icon text-white-50">
                                ...
                                <table id="table" class="display table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
										$nomor = 0;
										$sqlkat = "SELECT * FROM paket ORDER BY nama_paket ASC";
										...
										<tr>
											...
											<td class="text-center">
												<a href="paket-edit.php?id=<?php echo $result['id_paket'];?>" 
												...
												onclick="Swal.fire({
													icon: 'warning',
													title: 'Sure',
													text: 'Apakah Kamu Yakin Akan Menghapus Paket <?php echo htmlentities($result['nama_paket']);?> Ini ?',
													showCancelButton: true,
													confirmButtonText: 'Yes Delete It',
														}).then((result) => {
														if (result.isConfirmed) {
														window.location = 'paket-del.php?id=<?php echo $result['id_paket'];?>';
														}
													})">
	...
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Yes Delete All',
				...
				if (result.isConfirmed) {
				window.location = 'paket-delall.php';
				}
			})
		}
	</script>
