								...
								<div class="col-lg-12">
									<div class="pb-5 pr-5 pl-5 pt-3">
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Foto 4 Sekarang</label>
												<?php 
												...
												?>
												<div class="col-sm-8">
													<img src="img/kaos/<?php echo htmlentities($result['image4']);?>" width="300" height="200" style="border:solid 1px #000">
												</div>
											<?php }?>
											</div>
