          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Kategori</strong>: <?php echo htmlentities($result['kategori']);?> T-Shirt</li>
            ...
            <div class="portfolio-description">
			  ...
			  <form method="get">
				...
				<div class="form-group" align="center">
					<a type="button" class="col-md-12 btn btn-primary btn-block" href="#"
						onclick="(Swal.fire({
						icon: 'info',
						title: 'Sure',
			   ...
			   <?php } else { ?>
			   	<div class="form-group" align="center">
				<a class="col-md-12 btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#loginForm">Login Untuk Memesan</a>
