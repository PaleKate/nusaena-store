        ...
        <div id="content-wrapper" class="d-flex flex-column ml-auto">
            ...
            <div id="content" class="mt-4">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Katalog Products</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								...
								<a href="kategori-tambah.php" class="btn btn-sm btn-primary btn-icon-split">
									<span class="icon text-white-50">
										<i class="fas fa-plus"></i>
									</span>
									<span class="text">Add Katalog</span>
								</a>
								<div class="my-3"></div>
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td class="text-center">
												<a href="kategori-edit.php?id=<?php echo $result['id_kategori'];?>" 
												...
												onclick="Swal.fire({
													icon: 'warning',
													title: 'Sure',
													text: 'Apakah Kamu Yakin Akan Menghapus Kategori <?php echo htmlentities($result['kategori']);?> Ini ?',
													showCancelButton: true,
													confirmButtonText: 'Yes Delete It',
														}).then((result) => {
														if (result.isConfirmed) {
														window.location = 'kategori-del.php?id=<?php echo $result['id_kategori'];?>';
														}
													})">
