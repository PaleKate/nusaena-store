							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pb-5 pr-5 pl-5 pt-3">
										<h1 class="h4 text-gray-900">Form Edit Bahan</h1>
										<hr>
											<?php 
												$id=intval($_GET['id']);
											...
											?>
										<form class="user" method="post" name="theform" action="bahan-editact.php" 
										onSubmit="return valid(this);" enctype="multipart/form-data">
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<input type="text" class="form-control form-control-user" name="bahan" 
													value="<?php echo htmlentities($result['bahan']);?>" required>
												</div>
