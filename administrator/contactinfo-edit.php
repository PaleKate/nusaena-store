        ...
        <div id="content-wrapper" class="d-flex flex-column ml-auto">
            ...
            <div id="content" class="mt-4">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Bahan</h1>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pb-5 pr-5 pl-5 pt-3">
										<h1 class="h4 text-gray-900">Form Edit Page Info</h1>
										<hr>
											<?php 
												$id=intval($_GET['id']);
												$sql ="SELECT * FROM contactusinfo WHERE id_info='$id'";
										...
										enctype="multipart/form-data">
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<input type="text" class="form-control form-control-user" name="info" 
													value="<?php echo htmlentities($result['page_name']);?>" required>
												</div>
											...
											<div class="form-group row row">
												<div class="col-sm-12 mb-3 mb-sm-0">
													...
													required><?php echo htmlentities($result['detail']);?></textarea>
												</div>
											</div>
											<hr>
...
$detail=$_POST['detail'];
$id=$_POST['id'];
$sql="UPDATE contactusinfo SET page_name='$info', detail='$detail' WHERE id_info='$id'";
$query 	= mysqli_query($koneksidb,$sql);
if($query){
	...
	echo "<script type='text/javascript'>
			Swal.fire({
			  ...
			  text: 'Terjadi Kesalahan Update Data!'
				...
				window.location = 'contactinfo-edit.php?id=$id';
			});
		</script>";
	}
}	
