        ...
        <div id="content-wrapper" class="d-flex flex-column ml-auto">
            ...
            <div id="content" class="mt-4">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Kategori</h1>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pb-5 pr-5 pl-5 pt-3">
										<h1 class="h4 text-gray-900">Add New Kategori</h1>
										<hr>
										<form class="user" method="post" name="theform" action="kategori-tambahact.php" 
										onSubmit="return valid(this);" enctype="multipart/form-data">
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													<label class="control-label">Nama Kategori<span style="color:red">*</span></label>
													<input type="text" class="form-control form-control-user" name="kategori" required>
												</div>
