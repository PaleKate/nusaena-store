        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
			  <?php
				$kid=intval($_GET['kid']);
				$sql2 = "SELECT * FROM kategori WHERE id_kategori='$kid'";
				$query2 = mysqli_query($koneksidb,$sql2);
					while($result = mysqli_fetch_array($query2))
					{ ?>
              <li data-filter=".filter-<?php echo htmlentities($result['kategori']);?>" class="filter-active">
				<?php echo htmlentities($result['kategori']);?>
			  </li>
			  <?php } ?>
            </ul>
          </div>
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
			<?php 
				...
				$sqlkaos = "SELECT produk.*, kategori.*, bahan.* FROM produk, kategori, bahan 
							WHERE produk.id_kategori=kategori.id_kategori AND produk.id_bahan=bahan.id_bahan AND kategori.id_kategori='$id'
							ORDER BY nama_produk ASC";
				$querykaos = mysqli_query($koneksidb,$sqlkaos);
				if(mysqli_num_rows($querykaos)>0)
					{
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo htmlentities($result['kategori']);?>">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p><?php echo format_rupiah(htmlentities($result['harga']));?></p>
                <div class="portfolio-links">
                  ...
                  <?php if($_SESSION['ulogin']){?>
					...
					<?php }} else { ?>
			<h3 class="text-center" style="font-weight: bold;">No Data Available</h3>
					<?php }?>
        </div>
