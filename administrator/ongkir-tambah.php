							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pb-5 pr-5 pl-5 pt-3">
										...
										<hr>
										<form class="user" method="post" name="theform" action="ongkir-tambahact.php" 
										onSubmit="return valid(this);" enctype="multipart/form-data">
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<select class="form-control select2" name="id_kurir" required="">
														<option selected="selected" value="">== Pilih Jasa Kurir ==</option>
														<?php
											...
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													...
													<input type="number" class="form-control form-control-user" name="harga_ongkir" min="0" required>
												</div>
												...
												<div class="col-sm-6">
													...
													<select class="form-control select2" name="id_kota" required="">
														<option selected="selected"value="">== Pilih Kota/Kab ==</option>
														<?php
