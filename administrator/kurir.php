        ...
        <div id="content-wrapper" class="d-flex flex-column ml-auto">
            ...
            <div id="content" class="mt-4">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Jasa Kurir</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								...
								<a href="kurir-tambah.php" class="btn btn-sm btn-primary btn-icon-split">
									<span class="icon text-white-50">
										<i class="fas fa-plus"></i>
									</span>
									<span class="text">Add Jasa Kurir</span>
								</a>
								<div class="my-3"></div>
                                <table id="table" class="display table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
										$nomor = 0;
										$sqlkat = "SELECT * FROM kurir ORDER BY nama_kurir ASC";
										...
										<tr>
											...
											<td class="text-center">
												<a href="kurir-edit.php?id=<?php echo $result['id_kurir'];?>" 
												...
												onclick="Swal.fire({
													icon: 'warning',
													title: 'Sure',
													text: 'Apakah Kamu Yakin Akan Menghapus Jasa Kurir <?php echo htmlentities($result['nama_kurir']);?> Ini ?',
													showCancelButton: true,
													confirmButtonText: 'Yes Delete It',
														}).then((result) => {
														if (result.isConfirmed) {
														window.location = 'kurir-del.php?id=<?php echo $result['id_kurir'];?>';
														}
													})">
	...
	<script type="text/javascript">
        function deleteall() {
			...
			confirmButtonText: 'Yes Delete All',
				...
				if (result.isConfirmed) {
				window.location = 'kurir-delall.php';
				}
			})
		}
	</script>
